...
/datum/job/vamp/bruiser
	...
	v_duty = "You are the enforcer of the San Francisco Barony. The baron is always in need of skilled hands, like yours. Keep the Free State alive - even while under occupation."
