...
/obj/machinery/mineral/equipment_vendor/fastfood/clothing
	...
	prize_list = list(new /datum/data/mining_equipment("crimson red dress",	/obj/item/clothing/under/vampire/primogen_toreador/female	,	350),
		...
		new /datum/data/mining_equipment("white suit",	 /obj/item/clothing/under/suit/white,	60),
		new /datum/data/mining_equipment("beige suit",	 /obj/item/clothing/under/suit/beige,	60),
		new /datum/data/mining_equipment("tuxedo",	 /obj/item/clothing/under/suit/tuxedo,	60),
		new /datum/data/mining_equipment("tan suit",	 /obj/item/clothing/under/suit/tan,	60),
		new /datum/data/mining_equipment("checkered suit",	 /obj/item/clothing/under/suit/checkered,	60),
		new /datum/data/mining_equipment("burgundy suit",	 /obj/item/clothing/under/suit/burgundy,	60),
		new /datum/data/mining_equipment("navy suit",	 /obj/item/clothing/under/suit/navy,	60),
		new /datum/data/mining_equipment("charcoal suit",	 /obj/item/clothing/under/suit/charcoal,	60),
		new /datum/data/mining_equipment("red suit",	 /obj/item/clothing/under/suit/red,	60),
		new /datum/data/mining_equipment("green suit",	 /obj/item/clothing/under/suit/green,	60),
		new /datum/data/mining_equipment("waiter suit",	 /obj/item/clothing/under/suit/waiter, 60),
