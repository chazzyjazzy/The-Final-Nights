...
/atom/movable/screen/fullscreen/maniac
	icon = 'code/modules/antagonists/maniac/icons/fullscreen.dmi'
	icon_state = "hall0"
	alpha = 0
...
/atom/movable/screen/fullscreen/maniac/proc/jumpscare(mob/living/scared, silent = FALSE, fade_in = 0.2 SECONDS, duration = 0.5 SECONDS, fade_out = 1 SECONDS)
	if(!silent)
		var/static/list/spookies = list(
			'code/modules/antagonists/maniac/sounds/hall_appear1.ogg',
			'code/modules/antagonists/maniac/sounds/hall_appear2.ogg',
			'code/modules/antagonists/maniac/sounds/hall_appear3.ogg',
		)
...
/atom/movable/screen/fullscreen/dreaming
	icon = 'code/modules/antagonists/maniac/icons/fullscreen_wakeup.dmi'
	icon_state = "dream"
