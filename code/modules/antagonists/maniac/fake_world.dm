/obj/structure/fake_door
	icon = 'code/modules/antagonists/maniac/icons/dreamer_structures.dmi'
...
/turf/open/floor/plasteel/maniac
	icon = 'code/modules/antagonists/maniac/icons/dreamer_floors.dmi'
	icon_state = "polar"
...
/obj/item/clothing/head/cyberdeck
	...
	desc = "Sweet dreams..."
	icon = 'code/modules/antagonists/maniac/icons/clothing.dmi'
