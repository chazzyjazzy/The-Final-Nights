...
/proc/handle_maniac_visions(mob/living/target, atom/movable/screen/fullscreen/maniac/hallucinations)
	...
	//Random laughter
		...
		var/static/list/funnies = list(
			'code/modules/antagonists/maniac/sounds/comic1.ogg',
			'code/modules/antagonists/maniac/sounds/comic2.ogg',
			'code/modules/antagonists/maniac/sounds/comic3.ogg',
			'code/modules/antagonists/maniac/sounds/comic4.ogg',
		)
...
/proc/handle_maniac_object_hallucination(mob/living/target)
	...
	var/static/list/speech_sounds = list(
		'code/modules/antagonists/maniac/sounds/female_talk1.ogg',
		'code/modules/antagonists/maniac/sounds/female_talk2.ogg',
		'code/modules/antagonists/maniac/sounds/female_talk3.ogg',
		'code/modules/antagonists/maniac/sounds/female_talk4.ogg',
		'code/modules/antagonists/maniac/sounds/female_talk5.ogg',
		'code/modules/antagonists/maniac/sounds/male_talk1.ogg',
		'code/modules/antagonists/maniac/sounds/male_talk2.ogg',
		'code/modules/antagonists/maniac/sounds/male_talk3.ogg',
		'code/modules/antagonists/maniac/sounds/male_talk4.ogg',
		'code/modules/antagonists/maniac/sounds/male_talk5.ogg',
		'code/modules/antagonists/maniac/sounds/male_talk6.ogg',
	)
...
/proc/handle_maniac_mob_hallucination(mob/living/target)
	...
	if(mob_message == "It's mom!")
		mob_state = "mom"
	var/image/mob_image = image('code/modules/antagonists/maniac/icons/dreamer_mobs.dmi', spawning_turf, mob_state, FLOAT_LAYER, get_dir(spawning_turf, target))
	...
	var/static/list/spookies = pick(
		'code/modules/antagonists/maniac/sounds/hall_attack1.ogg',
		'code/modules/antagonists/maniac/sounds/hall_attack2.ogg',
		'code/modules/antagonists/maniac/sounds/hall_attack3.ogg',
		'code/modules/antagonists/maniac/sounds/hall_attack4.ogg',
	)
...
/proc/handle_maniac_wall(turf/closed/wall, mob/living/target)
	var/image/shit = image('code/modules/antagonists/maniac/icons/shit.dmi', wall, "splat[rand(1,8)]")
...
/datum/antagonist/marauder/proc/handle_waking_up_floor(turf/open/floor, mob/living/dreamer)
	var/mutable_appearance/fake_floor = image('code/modules/antagonists/maniac/icons/dreamer_floors.dmi', floor,  pick("rcircuitanim", "gcircuitanim"), floor.layer + 0.1)
